...
(function(root, factory) {
	...
	var defaults = {
		...
		messageTooShort: 'Lengthen this text to {minLength} characters or more.',
		messageTooLong: 'Shorten this text to no more than {maxLength} characters.',
...
function submit(id) {
	...
	var jsonData = {};
	var finalEndpoint = 'https://rocket-chat-mail-contact-form.now.sh';
